...
var mui = (function(document, undefined) {
  ...
  //     return this[0].indexOf(mui( elem )) ;
  //   }
...
(function($, window, document) {
	...
	window.addEventListener('tap', function(event) {
        ...
        //触发展开事件
        $.trigger(cell, 'expand');
        if (typeof $.collapseOpenBack === 'function') {
            $(cell.parentNode.childNodes).each(function(index,item) {
              if(item.classList && item.classList.contains('mui-active')) {
